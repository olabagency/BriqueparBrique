// ShaderBackground — WebGL animated mesh gradient. Zero dependencies.
// Drop it behind your content: <div className="relative"><ShaderBackground className="absolute inset-0" />…
...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    const updateLayout = () => {
      bounds = canvas.getBoundingClientRect()
      resizeCanvas(); updatePointerTarget(); requestRender()
    }
